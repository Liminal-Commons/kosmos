...
- 54 tests passing → **now 26 kosmos-mcp tests passing** (kosmos tests archived)

**Psyche integration:** ✅ Complete
- Psyche oikos created: `genesis/psyche/`
- 7 psyche praxeis: `attend`, `release-attention`, `form-intention`, `activate-intention`, `fulfill-intention`, `list-intentions`, `disclose-mood`
- Full Layer 7 (soma + psyche) now operational
...
- [psyche/manifest.yaml](../psyche/manifest.yaml) — Psyche oikos manifest
- [psyche/praxeis/psyche.yaml](../psyche/praxeis/psyche.yaml) — Psyche praxeis (attention, intention, mood)
- [klimax/6-psyche/psyche.yaml](../klimax/6-psyche/psyche.yaml) — The inner life (klimax format)
- [klimax/3-polis/DESIGN.md](../klimax/3-polis/DESIGN.md) — Dwelling context
- [soma.yaml](soma.yaml) — Full schema (klimax format)
- [soma/praxeis/soma.yaml](praxeis/soma.yaml) — Interpreter-format praxeis
...
*Updated: 2026-01-23 — Psyche oikos created, Layer 7 fully operational*
