...
An parousia inhabits the full scale through:

| Scale | Topos | What It Provides |
|-------|-------|-----------------|
...
Within the journey, the parousia:
...
nous/crystallize-theoria(
  ...
  → theoria entity bonded to oikos via crystallized-in
...
soma/depart-parousia(parousia_id)
  → closes all channels
  → marks parousia departed
```
...
This creates a mood entity bonded to parousia. The compose-constitution praxis can surface mood patterns.
