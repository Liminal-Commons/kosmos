...
> **Status:** Active
> **Waiting on:** Binary consolidation (merge kosmos-mcp into chora)
...
- Same **parousia** (authenticated user)
...
1. Track active channels per parousia
